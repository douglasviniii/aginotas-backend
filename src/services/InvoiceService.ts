...
const FindInvoiceCustomer = (id: string) => Invoice.find({customer: id}).sort({ _id: -1 }).populate("user");
...
export default {CreateInvoiceService,FindInvoices,FindInvoiceCustomer,FindAllInvoices,FindLastInvoice,DeleteInvoice,UpdateInvoice};